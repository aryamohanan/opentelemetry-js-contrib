...
Prior to version `0.57.0`, this instrumentation created spans targeting an experimental semantic convention Version 1.27.0.
...
`@opentelemetry/instrumentation-ioredis` versions 0.57.0 and later include support for migrating to stable Database semantic conventions, as described below.
